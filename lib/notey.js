...
*/
    ...
    initStyles() {
        ...
        st.innerHTML += '.dragbar { overflow: hidden; position: absolute; width: 100%; background-color: rgba(0,0,0,0.1); display: none; height: 20px; cursor: grab; }';
        ...
        st.innerHTML += '.dragbar-button { width: 16px; height: 16px; background-color: #888; margin: 2px 1px; cursor: pointer; border-radisu: 3px; ';
        st.innerHTML += 'float: right; text-align: center; font-weight: bold; font-family: arial, sans; font-size: 14px; color: #FFF; }';
