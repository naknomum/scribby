...
class Scribby {
    ...
    undo() {
        if (!this.svgEl.lastElementChild || (this.svgEl.lastElementChild.nodeName != 'path')) return;
        this._undid.push(this.svgEl.lastElementChild.cloneNode());
        this.svgEl.lastElementChild.remove();
    }
    redo() {
        if (!this._undid.length) return;
